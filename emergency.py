...
class EmailConfig:
    ...
    SMTP_PORT = 587
    SMTP_USERNAME = os.environ.get('SMTP_USERNAME', 'arunvinayan202@gmail.com')
    SMTP_PASSWORD = os.environ.get('SMTP_PASSWORD', 'abix qazs uihe qpsk')
    SENDER_EMAIL = os.environ.get('SENDER_EMAIL', 'arunvinayan202@gmail.com')
...
flood_model = joblib.load(r'C:\Users\Rasheed\Desktop\emergency\rainfall.pkl')
landslide_model = joblib.load(r'C:\Users\Rasheed\Desktop\emergency\landslidee.pkl')
earthquack_model = joblib.load(r'C:\Users\Rasheed\Desktop\emergency\earthquack_model.pkl')
tornadoes_model = joblib.load(r"C:\Users\Rasheed\Desktop\emergency\tornadoes.pkl")
tsunami_model = joblib.load(r'C:\Users\Rasheed\Desktop\emergency\random_forest_tsunami_model.pkl')
...
def home():
    ...
    WEATHER_API_KEY = "6XFT3BWRJMSG3FAU9KRKQDN9R"
    ...
    api_key = "6XFT3BWRJMSG3FAU9KRKQDN9R"  # Replace with your actual API key
    ...
    # landslide_pred[0]=1
    # earthquake_mag=9
    # tornado_result = tornado_results[4]
    # tsunami_pred[0]+=3
...
ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'admin123')  # Use a strong password in production
...
TWILIO_FROM_NUMBER = '+18317099124'  # Replace with your Twilio phone number in E.164 format
...
def send_emergency_sms():
    try:
        ...
        if landslide_result == "Landslide Predict":
            alert_messages.append("⛰ Landslide Warning")
        
        if tornado_result == "Considerable Cyclone" or tornado_result in [
            "Severe Cyclone",
            "Incredible Cyclone"
        ]:
            alert_messages.append(f"🌪 Cyclone Alert: {tornado_result}")
